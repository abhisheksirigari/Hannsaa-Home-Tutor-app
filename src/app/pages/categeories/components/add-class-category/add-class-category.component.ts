...
@Component({
  selector: 'app-add-class-category',
  templateUrl: './add-class-category.component.html',
  styleUrls: ['./add-class-category.component.scss']
})
export class AddClassCategoryComponent implements OnInit {
